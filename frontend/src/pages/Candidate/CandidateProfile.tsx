    ...
    <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 text-xl font-bold text-slate-100">{fullName || 'Not provided'}</h1>
      ...
      <section className={`rounded-lg border p-5 ${isDark ? 'border-navy-700 bg-navy-800' : 'border-slate-200 bg-white'}`}>
        <div className="flex items-center gap-2 border-b border-navy-700 pb-3 mb-4">
          ...
          <h2 className="text-base font-bold text-slate-100">Resume upload</h2>
        </div>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <label className="flex min-w-0 flex-1 cursor-pointer items-center justify-between rounded-lg border border-dashed border-navy-700 bg-navy-850 px-4 py-3 hover:border-brand transition">
            <span className="flex min-w-0 items-center gap-3 text-xs font-semibold text-slate-300">
      ...
      {parsedResume && (
        <section className={`rounded-lg border p-5 ${isDark ? 'border-amber-500/30 bg-amber-500/5' : 'border-amber-200 bg-amber-50/50'}`}>
          <div className="flex flex-col justify-between gap-3 border-b border-amber-500/30 pb-4 sm:flex-row sm:items-center">
            <div>
              <h2 className="font-bold text-slate-100">Review extracted information</h2>
              <p className="text-xs text-slate-400">AI output is a draft. Edit it here, then save to your profile.</p>
            </div>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <label className="text-xs font-semibold text-slate-300">Education</label>
      ...
      <form onSubmit={(event) => void handleSaveProfile(event)} className={`rounded-lg border p-5 ${isDark ? 'border-navy-700 bg-navy-800' : 'border-slate-200 bg-white'}`}>
        <div className="border-b border-navy-700 pb-4 mb-4">
          <h2 className="text-base font-bold text-slate-100">Profile information</h2>
          <p className="text-xs text-slate-400">Review or edit your information before saving.</p>
        </div>
        ...
        <div className="mt-6">
          <h3 className="flex items-center gap-2 text-sm font-bold text-slate-200"><Briefcase className="h-4 w-4 text-brand" />Professional information</h3>
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <div>
              <label className="text-xs font-semibold text-slate-300">Experience years</label>
            ...
            <div className="sm:col-span-2">
              <label className="text-xs font-semibold text-slate-300">Experience summary</label>
        ...
        <div className="mt-6">
          <h3 className="flex items-center gap-2 text-sm font-bold text-slate-200"><GraduationCap className="h-4 w-4 text-brand" />Education</h3>
          <div className="mt-4">
            <label className="text-xs font-semibold text-slate-300">Education summary</label>
        ...
        <div className="mt-6">
          <h3 className="flex items-center gap-2 text-sm font-bold text-slate-200"><FileText className="h-4 w-4 text-brand" />Skills</h3>
          <div className="mt-4">
        ...
        <div className="mt-6">
          <label className="text-xs font-semibold text-slate-300">Resume URL</label>
